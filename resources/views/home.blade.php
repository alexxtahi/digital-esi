          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              ...
              <div class="text border border-top-0 p-4">
                <h3 class="heading"><a href="#">Lancement de la plateforme officielle de communication de l'ESI !</a></h3>
                <p>L'Ecole formatrice d'ingénieurs et de techniciens supérieurs dans les domaines de l'industrie vous dévoile sa plateforme digitale.</p>
